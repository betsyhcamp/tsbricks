...
# ---- BoxCoxTransform: functional tests ----


def test_round_trip_fidelity(boxcox_panel_df: pd.DataFrame) -> None:
...
def test_per_series_independent_lambdas(boxcox_panel_df: pd.DataFrame) -> None:
...
def test_input_dataframe_not_mutated(boxcox_panel_df: pd.DataFrame) -> None:
...
def test_transform_applies_stored_lambdas(boxcox_panel_df: pd.DataFrame) -> None:
...
def test_guerrero_method(boxcox_panel_df: pd.DataFrame) -> None:
...
def test_columns_preserved(boxcox_panel_df: pd.DataFrame) -> None:
