...
```bash
uv add git+https://github.com/betsyhcamp/tsbricks.git@v0.4.0
```
...
uv add "tsbricks[matplotlib] @ git+https://github.com/betsyhcamp/tsbricks.git@v0.4.0"

# Polars interop
uv add "tsbricks[polars] @ git+https://github.com/betsyhcamp/tsbricks.git@v0.4.0"

# Multiple extras
uv add "tsbricks[matplotlib,polars] @ git+https://github.com/betsyhcamp/tsbricks.git@v0.4.0"
```
